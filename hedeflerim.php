...
<form id= "main-wrapper" >
    ...
    <h2>Hedeflerim</h2>
            ...
            <table>
            <tr>
                <td><a style="color:white">Projenin İsmi</a></td>
        		<td><a style="color:white">Departman</a></td>
        		<td><a style="color:white">Proje Süresi</a></td>
                <td><a style="color:white">Proje Detayı</a></td>
    		</tr>
    ...
    <?php
        ...
        ?>
        <tr>
           <td><?php echo $row['hedefismi']; ?></td>
            <td><?php echo $row['Departman']; ?></td>
            <td><?php echo $row['hedefsuresi']; ?></td>
            <td><?php echo $row['HedefDetayi']; ?></td>
